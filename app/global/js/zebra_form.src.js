                        ...
                        'change': function() {
                            ...
                            if (undefined != validation_rules[attributes['name']]['rules']['upload']) {
                                ...
                                $form.attr('action',
                                    ...
                                    '&path=' + encodeURIComponent(decodeURIComponent(validation_rules[attributes['name']]['rules']['upload'])) +
        ...
        plugin.show_errors = function() {
            ...
            for (index in validation_rules) {
                ...
                var
                    ...
                    id = (attributes['type'] == 'radio' || attributes['type'] == 'checkbox' ? attributes['name'] : attributes['id']);
                                ...
                                case 'text':
                                    ...
                                    if ($.trim(element.val()) != '') {
                                        ...
                                        var
                                            ...
                                            format = element.data('Zebra_DatePicker').settings.format.replace(/\s/g, ''),
                        ...
                        case 'url':
                            ...
                            switch (attributes['type']) {
                                ...
                                case 'textarea':
                                    ...
                                    // the regular expression to use:
                                    var exp = new RegExp("^(http(s)?://)" + (control_validation_rules['rules'][rule][0] === '1' ? '' : '?') + "[^\\s\\.]+\\..{2,}", 'i');
