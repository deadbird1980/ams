            ...
            <tbody><tr>
                ...
                <td valign="top">
                    <div class="tab clearfix" style="display:block">
                      ...
                      <form name="form" id="form" action="<?php echo $data['baseurl']; ?>index.php/users/create" method="post" class="Zebra_Form">
                           <div class="hidden">
...
<table><tbody>
        <tr class="row">
            <td><label for="username" id="label_username">User name:<span class="required">*</span></label></td>
            <td><input name="username" id="username" value="" class="control text validate[required]" type="text"></td></tr>
        <tr class="row">
            <td><label for="firstname" id="label_firstname">First name:<span class="required">*</span></label></td>
            <td><input name="firstname" id="firstname" value="" class="control text validate[required]" type="text"></td></tr>
        <tr class="row even">
            <td><label for="lastname" id="label_lastname">Last name:<span class="required">*</span></label></td>
            <td><input name="lastname" id="lastname" value="" class="control text validate[required]" type="text"></td></tr>
        <tr class="row">
            <td><label for="firstname_alphabet" id="label_firstname_alphabet">First name(alpabet):<span class="required">*</span></label></td>
            <td><input name="firstname_alphabet" id="firstname_alphabet" value="" class="control text validate[required]" type="text"></td></tr>
        <tr class="row even">
            <td><label for="lastname" id="label_lastname">Last name:<span class="required">*</span></label></td>
            <td><input name="lastname" id="lastname" value="" class="control text validate[required]" type="text"></td></tr>
        <tr class="row">
            <td><label for="email" id="label_email">Email address:<span class="required">*</span></label></td>
            <td><input name="email" id="email" value="" class="control text validate[required,email]" type="text">
    ...
    address with a link you need to click on in order to activate your account</div></td></tr>
        <tr class="row even">
            ...
            <td><input name="password" id="password" value="" class="control password validate[required,length(6,10)]" maxlength="10" type="password">
                <div class="note" id="note_password">Password must be have between 6 and 10 characters.</div></td></tr>
        <tr class="row"><td><label for="confirm_password" id="label_confirm_password">Confirm password:</label></td>
            <td><input name="confirm_password" id="confirm_password" value="" class="control password validate[compare(password)]" type="password"></td></tr>
        <tr class="row even">
